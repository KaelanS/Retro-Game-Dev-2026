...
+canHurtPlayer:
    ...
    +notAlreadyInHurtState
        ...
        JMP +skipHurt
+playerHealthIsZero:
    ;; 1. Use the macro for 2-digit variables
    AddValue #$02, myScore, #$01, #$00 

    ;; 2. Update the correct HUD element (Index 5)
    UpdateHudElement #$05 

    ;; 3. Change transition to a basic warp (#$00)
    ;; Type #$02 is a "Continue" which often reloads initial values.
    LDA continueMap
    STA warpMap
    LDA continueScreen
