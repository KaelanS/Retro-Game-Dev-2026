   ...
   ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ...
    ;;; Constants do not take up any memory.
        WEAPON_POSITION_RIGHT_X = #$0D
        WEAPON_POSITION_RIGHT_Y = #$FE
        WEAPON_POSITION_UP_X = #$FE
        WEAPON_POSITION_UP_Y = #$F4
        WEAPON_POSITION_DOWN_X = #$02
        WEAPON_POSITION_DOWN_Y = #$0E
        WEAPON_POSITION_LEFT_X = #$F2
        WEAPON_POSITION_LEFT_Y = #$FC
        WEAPON_OBJECT = #$03
