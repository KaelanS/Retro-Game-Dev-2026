...
+continueRoutine		
		...
		BNE notEndOfText
		endOfText:
			;; --- KEY REWARD LOGIC START ---
			LDA screenType           ; Check if this is a "Key Room"
			CMP #01                  ; if screen type is 1
			BNE +notKeyRoom          ; If not, skip

			;; Check if this screen is already triggered
			LDY #$00 
			LDA screenTriggers       ; Check the global trigger variable
			AND #%00000001           ; Check Bit 0
			BNE +notKeyRoom          ; If already triggered, skip

			INC myKeys               ; Give the key
